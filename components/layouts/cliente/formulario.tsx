...
import cliente from "../../../app/api/client/route";
      ...
      <Grid item md={6}>
        ...
        >
          ...
          {formInput(
            ...
            handleNombreEmpresaChange
          )}
          {formInput("NIT", props.cliente.nit, handleNitChange)}
          {formInput(
            "Página web",
            props.cliente.pagina_web,
            handlePaginaWebChange
          )}
          {formInput(
            "Email de Notificaciones",
            props.cliente.email_calendario,
            handleEmailNotificacionesChange
          )}
        </Box>
      </Grid>
      <Grid item md={6}>
        ...
        >
          ...
          <FormControl sx={{ width: 300, marginTop: 3 }}>
            ...
            <Select
              value={props.cliente.tipo_persona}
